#include <ansi.h>
// 炼毒有点问题。需要设置corpse为自己杀的，还要check下。
//暂时保留一些加功夫的code，希望有人来练xingxiu，整理这些累死了。
inherit ITEM;
...
int do_liandu()
{
        ...
        if( me->query_skill("poison") > 400 )
                return notify_fail("你的毒计已经无法提高，炼毒提高对自身会造成莫大伤害！\n"); 
...
//        me->start_busy((: start_liandu :), (:halt_liandu:));
        me->start_busy("start_liandu");
        me->start_busy("halt_liandu");
        return 1;
 } 
