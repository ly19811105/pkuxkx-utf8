// advent.c，用来给arch做xcp和xrm
// 必须放在和巫师有同等读写权利的位置，如/u/iszt，不能放在/u/iszt/obj
// iszt@pkuxkx, 2007-02-11
