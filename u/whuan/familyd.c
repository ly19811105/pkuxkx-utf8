...
// Edit by      : kiden@pkuxk, 2007-03-30
...
int set_wudang(object me, int level, int armed)
{
        ...
        me->set_skill("taij-dao", level);
        me->set_skill("taij-jian", level);
        me->set_skill("sword", level);
        me->set_skill("blade", level);
        me->set_skill("cuff", level);
...
int set_gaibang(object me, int level, int armed)
{
        ...
        set("chat_chance_combat", 100);
        me->set("chat_msg_combat", ({
                (: perform_action, "stirke.xianglong" :),
...
int set_xingxiu(object me, int level, int armed)
{
        ...
        set("chat_chance_combat", 100);
        me->set("chat_msg_combat", ({
                (: perform_action, "stirke.huoqiang" :),
                (: perform_action, "stirke.huoqiu" :),
                (: perform_action, "stirke.sandu" :),   
...
int set_taohua(object me, int level, int armed)
{
        ...
        me->carry_object("/d/taohuadao/obj/shizi");
        me->carry_object("/d/taohuadao/obj/shizi");
        me->carry_object("/d/taohuadao/obj/shizi");
        me->carry_object("/d/taohuadao/obj/shizi");
        me->carry_object("/d/taohuadao/obj/shizi");
...
int set_mingjiao(object me, int level, int armed)
{
        ...
        me->set_skill("shenghuo-shengong", level);
        ...
        me->map_skill("sword", "shenghuo-shengong");
        me->prepare_skill("strike", "hanbing-mianzhang");
        if(armed)
          {
        ...
        me->set("chat_msg_combat", ({
                ...
                (: perform_action, "sword.fenxin" :),
                (: perform_action, "dodge.tisha" :),
                (: command("enable parry shenghuo-shengong") :),	//免得太强了
...
int set_lingjiu(object me, int level, int armed)
{
        ...
        me->prepare_skill("hand","zhemei-shou");if(armed)
          {
        me->set("use_weapon1", "sword");
        me->carry_object("/d/lingjiu/obj/jiudai");
        me->carry_object("/d/lingjiu/obj/jiudai");
        me->carry_object("/d/lingjiu/obj/jiudai");
        me->carry_object("/d/lingjiu/obj/jiudai");
        me->carry_object("/d/lingjiu/obj/jiudai");
        ...
        set("chat_chance_combat", 100);
        me->set("chat_msg_combat", ({
                (: perform_action, "throwing.escape" :),
