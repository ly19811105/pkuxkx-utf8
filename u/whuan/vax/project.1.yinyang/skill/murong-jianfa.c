...
mapping *action = ({
([      "action" : HIR "$N剑尖下指，一式「洗耳恭听」，双脚后退三步，剑尖直点$n腿部" NOR,
        "force" : 120,
        "dodge" : 20,
        "damage" : 25,
        "lvl" : 0,
...
([      "action" : HIB "$N踏前数步，避虚就实，右手使一式「明察秋毫」直刺$n的右肋" NOR,
        "force" : 160,
        "dodge" : 15,
        "damage" : 30,
        "lvl" : 20,
...
([      "action" : HIG "$N一招「甜言蜜语」，剑尖抖起五朵剑花，分别刺向$n的左脸和右耳" NOR,
        "force" : 220,
        "dodge" : 15,
        "damage" : 40,
        "lvl" : 45,
...
([      "action" : MAG "$N剑身横摆，剑尖指向$n的脸部，一招「望尘莫及」，宛若万马千军一般，横扫$n的$l" NOR,
        "force" : 270,
        "dodge" : 10,
        "damage" : 50,
        "lvl" : 60,
...
([      "action" : HIY "$N双脚离地，使出草上飞，身行直奔$n，一招「骑虎难下」，剑出中宫，平削$n的$l" NOR,
        "force" : 330,
        "dodge" : 10,
        "damage" : 60,
        "lvl" : 75,
...
([      "action" : HIC "$N长笑一声，横剑斜削，一招「抛砖引玉」，剑风逼向$n的$l" NOR,
        "force" : 380,
        "dodge" : 5,
        "damage" : 70,
        "lvl" : 90,
