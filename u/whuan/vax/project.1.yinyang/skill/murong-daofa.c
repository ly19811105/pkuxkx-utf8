...
mapping *action = ({
([      "action" : HIY"$N大喝一声「看招」，一招「劈天盖地满壮志」，刀锋自上而下向$n的$l挥去"NOR,
	"force" : 180,
        "dodge" : 10,
        "parry" : 10,
	"damage": 30,
...
([      "action" : HIB"$N一招「弯刀逆转倒乾坤」，手中$w在空中急速转动数圈，划向$n的$l"NOR,
	"force" : 260,
        "dodge" : 10,
        "parry" : 10,
	"damage": 70,
...
([      "action" : HIG"$N猛一挫身，一招「遥看万疆千里雪」,$w直向$n的颈中斩去"NOR,
	"force" : 320,
        "dodge" : 5,
        "parry" : 5,
	"damage": 120,
...
([      "action" : HIC"$N一招「壮志豪气满江湖」，无数刀尖化作点点繁星，向$n的$l挑去"NOR,
	"force" : 380,
        "dodge" : 10,
        "parry" : 5,
	"damage": 150,
