...
void attempt_apprentice(object ob)
{
        ...
        if (ob->query("dai")== 2 )
        {
                ...
                if (this_player()->query("is_beggar"))
                        this_player()->set("title",MAG "丐帮" NOR + BLK + "污衣派" + YEL +"二袋" NOR + MAG "弟子" NOR);
                else    this_player()->set("title",MAG "丐帮" NOR + HIC + "净衣派" + YEL +"二袋" NOR + MAG "弟子" NOR);
                return;
        }
