//  /ludingshan/npc/obj/jing42_5.c 四十二章经之五
// hongdou 98.10.18
...
void create()
{
        set_name(HIR"四十二"HIB"章经"NOR, ({"42 jing5","jing5","jing"}));
        set_weight(1000);
	set("no_give",1);
	set("no_put",1);
	set("no_steal",1);
	...
	set("no_get",1);
        if( clonep() )
                ...
                set("long", "\n一本"+HIB+"正蓝"+NOR+"旗的四十二章经，封皮(binding)很精致。\n");
                set("unit", "本");
                set("material", "paper");
		set("value",0);
        }
