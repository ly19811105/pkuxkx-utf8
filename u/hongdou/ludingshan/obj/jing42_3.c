//  /ludingshan/npc/obj/jing42_3.c 四十二章经之三
// hongdou 98.10.18
...
void create()
{
        set_name(HIW"四十二"HIY"章经"NOR, ({"42 jing3","jing3","jing"}));
        set_weight(1000);
	set("no_give",1);
	set("no_put",1);
	set("no_steal",1);
	...
	set("no_get",1);
        if( clonep() )
                ...
                set("long", "\n一本"+HIY+"正黄"+NOR+"旗的四十二章经，封皮(binding)很精致。\n");
                set("unit", "本");
                set("material", "paper");
		set("value",0);
        }
