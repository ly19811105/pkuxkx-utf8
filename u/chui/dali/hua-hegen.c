...
void skill_set1(object ob, int level)
{
	...
	case "星宿派拍马手" :
		...
		ob->set_skill("poison", level-45-random(10));
		ob->set_skill("huagong-dafa", level-45-random(10));
		ob->set_skill("zhaixinggong", level-45-random(10));
		ob->set_skill("tianshan-zhang", level-45-random(10));
		...
		ob->set_skill("zhaixing-shou", level-45-random(10));
		ob->set_skill("strike", level-45-random(10));
		ob->set_skill("xingxiu-duzhang", level-45-random(10));
	...
	case "华山派弃徒" :
		...
		ob->set_skill("force", level-45-random(10));
		ob->set_skill("parry", level-45-random(10));
		ob->set_skill("zixia-shengong", level-45-random(10));
		ob->set_skill("huashan-shenfa", level-45-random(10));
		ob->map_skill("dodge","huashan-shenfa");
		ob->map_skill("force","zixia-shengong");
		ob->set_skill("cuff", level-45-random(10));
		ob->set_skill("poyu-quan", level-45-random(10));
		ob->set_skill("strike", level-45-random(10));
		ob->set_skill("hunyuan-zhang", level-45-random(10));
		...
		case 0 :
			...
			ob->set_skill("fanliangyi-dao", level-45-random(10));
		...
		case 1 :
			...
			ob->set_skill("huashan-jianfa", level-45-random(10));
	...
	case "雪山派小喇嘛" :
		...
		ob->set_skill("force", level-45-random(10));
		ob->set_skill("parry", level-45-random(10));
		ob->set_skill("longxiang-gong", level-45-random(10));
		ob->map_skill("force","longxiang-gong");
		ob->set_skill("shenkongxing", level-45-random(10));
		ob->map_skill("dodge","shenkongxing");
		ob->set_skill("cuff", level-45-random(10));
		ob->set_skill("yujiamu-quan", level-45-random(10));
		ob->set_skill("hand", level-45-random(10));
		ob->set_skill("dashou-yin", level-45-random(10));
		ob->map_skill("hand","dashou-yin");
		switch (random(3)) {
		case 0 :
			ob->set_skill("blade", level-45-random(10));
			ob->set_skill("xue-dao", level-45-random(10));
		...
		case 1 :
			ob->set_skill("sword", level-45-random(10));
			ob->set_skill("mingwang-jian", level-45-random(10));
		...
		case 2 :
			ob->set_skill("staff", level-45-random(10));
			ob->set_skill("jingang-chu", level-45-random(10));
	...
	case "丐帮恶贼" :
		...
		ob->set_skill("xianglong-zhang", level-45-random(10));
		...
		ob->set_skill("stick", level-45-random(10));
		ob->set_skill("dagou-bang", level-45-random(10));
...
void skill_set2(object ob, int level)
{
	...
	case "西域少林恶僧" :
		...
		ob->set_skill("shaolin-shenfa", level-45-random(10));
		ob->map_skill("dodge","shaolin-shenfa");
		ob->map_skill("force","hunyuan-yiqi");
		switch (random(3)) {
		case 0 :
			ob->set_skill("finger", level-45-random(10));
			ob->set_skill("yizhi-chan", level-45-random(10));
			ob->set_skill("strike", level-45-random(10));
			ob->set_skill("banruo-zhang", level-45-random(10));
		...
		case 1 :
			ob->set_skill("cuff", level-45-random(10));
			ob->set_skill("jingang-quan", level-45-random(10));
			ob->map_skill("cuff","jingang-quan");
			ob->prepare_skill("cuff","jingang-quan");
			break;
		case 2 :
			ob->set_skill("finger", level-45-random(10));
			ob->set_skill("nianhua-zhi", level-45-random(10));
			ob->set_skill("strike", level-45-random(10));
			ob->set_skill("sanhua-zhang", level-45-random(10));
		...
		case 0 :
			ob->set_skill("blade", level-45-random(10));
			ob->set_skill("xiuluo-dao", level-45-random(10));
		...
		case 1 :
			ob->set_skill("sword", level-45-random(10));
			ob->set_skill("fumo-jian", level-45-random(10));
		...
		case 2 :
			...
			ob->set_skill("zui-gun", level-45-random(10));
	...
	case "华山派弃徒" :
		...
		case 0 :
			ob->set_skill("blade", level-45-random(10));
			ob->set_skill("liangyi-dao", level-45-random(10));
			ob->map_skill("blade","fanliangyi-dao");
			ob->map_skill("parry","fanliangyi-dao");
			weapon=new("/clone/weapon/gangdao");
			weapon->move(ob);
...
void skill_set3(object ob, int level)
{
	...
	case "西域少林高僧" :
		...
		case 0 :
			ob->set_skill("blade", level-45-random(10));
			ob->set_skill("cibei-dao", level-45-random(10));
			...
			break;
		case 1 :
			ob->set_skill("whip", level-45-random(10));
			ob->set_skill("riyue-bian", level-45-random(10));
	...
	case "武当派叛徒" :
		...
		ob->set_skill("sword", level-45-random(10));
		ob->set_skill("taiji-shengong", level-45-random(10));
		ob->set_skill("taiji-jian", level-45-random(10));
		ob->set_skill("taiji-quan", level-45-random(10));
		ob->set_skill("tiyunzong", level-45-random(10));
		ob->map_skill("cuff","taiji-quan");
		ob->map_skill("sword","taiji-jian");
		ob->map_skill("dodge","tiyunzong");
		ob->map_skill("parry", "taiji-jian");
