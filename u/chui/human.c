...
void setup_human(object ob)
{
	mapping my;
	int xism_age;
	int jiu_skill,tai_skill,hun_skill;
	...
	if( userp(ob) || undefinedp(my["max_jing"]) ) {
		...
		jiu_skill = (int)ob->query_skill("jiuyang-shengong", 1)/20;   
		hun_skill = (int)ob->query_skill("hunyuan-yiqi", 1)/10; 
		tai_skill = (int)ob->query_skill("taiji-shengong", 1)/10; 
		...
		if(((xism_age=(int)ob->query_skill("jiuyang-shengong", 1)) > 39) && (jiu_skill > hun_skill));
		{
			...
			if (xism_age > 0) my["max_jing"] += xism_age *jiu_skill; 
		}                            
                ...
                if((xism_age=(int)ob->query_skill("mahayana", 1)) > 39)
		{
			...
			if (xism_age > 0) my["max_jing"] += xism_age *((int)ob->query_skill("linji-zhuang", 1)/10); 
		}
                if((xism_age=(int)ob->query_skill("daguanming", 1)) > 39)
		{
			...
			if (xism_age > 0) my["max_jing"] += xism_age*((int)ob->query_skill("tianmo-dafa", 1)/10); 
		}
	...
	if( userp(ob) || undefinedp(my["max_qi"]) ) {
		...
		else if( my["age"] > 60 ) my["max_qi"] = my["con"] * 16 + 100 - (my["age"] - 60) * 5;
               ...
               if((xism_age=(int)ob->query_skill("daguanming", 1)) > 39)
		{
			...
			if (xism_age > 0) my["max_qi"] += xism_age*((int)ob->query_skill("tianmo-dafa", 1)/10); 
		}
