...
if (me->query("zhongqiu/gift_yuebing")) return "你已经吃过月饼了，为人不要贪得无厌！\n";
if (me->query("zhongqiu/ask")) return "你刚才不是问过了吗，你烦不烦呀？\n";
