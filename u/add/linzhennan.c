...
{   int n,exp;
    ...
    if ( ob->query("in_dart"))
    {
		...
		exp = ob->query("yunbiao/last_reward");
		if (exp == 0)
			exp = 2500;
    		ob->add("combat_exp",-exp*2);
		ob->add("potential",-exp/5);
		if (ob->query("potential")<ob->query("learned_points"))
			ob->set("potential",ob->query("learned_points"));
    		ob->add("repute",-exp*2);
    		ob->delete("in_dart");
...
//      creward=(random(40)+25)*ob->query_temp("yunbiao/bonus");
      creward=(random(25)+25)*ob->query_temp("yunbiao/bonus");
//     preward=(random(5)+3)*ob->query_temp("yunbiao/bonus");
     preward=(random(3)+3)*ob->query_temp("yunbiao/bonus");
//      rreward=(5+random(3))*ob->query_temp("yunbiao/bonus");
        rreward=(3+random(3))*ob->query_temp("yunbiao/bonus");
...
//     creward=(random(50)+30)*ob->query_temp("yunbiao/bonus");
   creward=(random(25)+30)*ob->query_temp("yunbiao/bonus");
//     preward=(random(8)+3)*ob->query_temp("yunbiao/bonus");
 preward=(random(5)+3)*ob->query_temp("yunbiao/bonus");
//  rreward=(10+random(10))*ob->query_temp("yunbiao/bonus");
     rreward=(10+random(6))*ob->query_temp("yunbiao/bonus");
    creward=creward*ob->query_temp("yunbiao/lianxu");
    preward=preward*ob->query_temp("yunbiao/lianxu");
    rreward=rreward*ob->query_temp("yunbiao/lianxu");
    ob->add("combat_exp",creward);
