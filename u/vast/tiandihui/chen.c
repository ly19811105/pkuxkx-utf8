...
void create()
{
	...
	carry_object("/d/beijing/npc/obj/jinduan")->wear();

	carry_object("/d/beijing/npc/obj/yaodai")->wear();

	carry_object("/clone/weapon/changjian")->wield();

	carry_object("/d/beijing/npc/obj/hlbian")->wield();
...

{
	...
	if(this_player()->query_skill("yunlong-jian") < 70)
        ob = new("/d/beijing/npc/obj/yljianpu1");
        else if(this_player()->query_skill("yunlong-jian") >= 70)
