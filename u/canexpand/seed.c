...
void create()
{
        set("short", "扩充地图系统");
        set("long", ""
/*DESCRIBE*/"这里可以扩充地图，但需要天神的授权."+"\n"
/*DESCRIBE*/"可以用help命令查看本系统的用法．\n"
/*DESCRIBE*/"目前颜色还不支持，大家加油玩！　mudy\n"
/*DESCRIBE*/"当你del了一个路径想马上重写时，请不要用相同的文件命重写，不然会出小问题，大家注意。\n"
//DESCRIBE
//DESCRIBE
//DESCRIBE
//DESCRIBE
...
//OVERDESCRIBE
        ...
        set("exits", ([
/*EXIT*/"north":"/d/city/ximen",
"east":"/u/canexpand/sssjiao.c",
"south":"/u/canexpand/xiaolu.c",
"west":"/u/canexpand/murong.c",
"northup":"/u/canexpand/qu1.c",
"southup":"/u/canexpand/kuozhan.c",
"up":"/u/canexpand/xiangju.c",
//EXIT
//EXIT
//EXIT
//EXIT
