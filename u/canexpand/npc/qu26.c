...
/*NICKNAME*/ set("nickname","四大名捕之无情");
        set("long",""
/*DESCRIBE*/+"他看起来冷酷无情，眉宇间又有一股浩然正气咄咄逼人。\n"
/*DESCRIBE*/+"他身手敏捷，一看就是练家子。\n"
/*DESCRIBE*/+"自己掂量掂量要是没有两把刷子的话还是不要跟他动手的好。\n"
//DESCRIBE
//DESCRIBE
//DESCRIBE
//DESCRIBE
...
/*CANEXPAND*/  set("canexpand",1);
        set("chat_chance", 5);
        set("chat_msg", ({
/*MSG_CHAT*/"我们丐帮的“降龙十八掌”是天下最霸道的掌法！！！\n",
/*MSG_CHAT*/"大丈夫一言既出，驷马难追。\n",
//MSG_CHAT
//MSG_CHAT
//MSG_CHAT
//MSG_CHAT
...
/*SKILL*/  set_skill("xianglong-zhang",450);
...
/*SKILL*/  set_skill("xiake-shengong",450);
...
//SKILL
//OVERSKILL
/*MAP*/   map_skill("parry","xianglong-zhang");
/*MAP*/   map_skill("force","huntian-qigong");
/*MAP*/   map_skill("strike","xianglong-zhang");
...
/*MAP*/   map_skill("spear","yuejia-qiangfa");
/*MAP*/   map_skill("unarmed","xiake-quanjiao");
//MAP
//MAP
//MAP
//MAP
...
/*PREPARE*/   prepare_skill("strike","xianglong-zhang");
//PREPARE
//PREPARE
//OVERPREPARE
        setup();
