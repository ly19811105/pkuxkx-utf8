...
if(me->query_temp("weapon")&&!zhe->query_temp("weapon")) exp=exp/3*2;
if(exp<1) exp=1;
...
{
write(MAG"恭喜！您打破了自己单场奖励的最高记录!\n这是您自己对自己极限的一次成功挑战！\n"NOR);
write(HIY"您将会得到本场奖励的十分之一作为额外的奖励！\n"NOR);
...
{
write(MAG"恭喜！您打破了自己连胜场数的最高记录!\n这是您自己对自己极限的一次成功挑战！\n"NOR);
write(HIY"您将会得到到目前为止本轮奖励的十分之一作为额外的奖励！\n"NOR);
