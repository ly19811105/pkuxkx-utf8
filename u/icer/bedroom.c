...
add_action("do_arg","arg");
}
int abc(string arg1,string arg2,string arg3)
{
	if (arg3)
		tell_room(this_object(),"3!");
	if (arg2 && !arg3)
		tell_room(this_object(),"2!");
	if (arg1 && !arg2)
		tell_room(this_object(),"1!");
	return 1;
}
int do_arg(string arg)
{
	if (arg == "1") call_out("abc",1,"1");
	if (arg == "2") call_out("abc",1,"1","2");
	if (arg == "3") call_out("abc",1,"1","2","3");
	return 1;
}
